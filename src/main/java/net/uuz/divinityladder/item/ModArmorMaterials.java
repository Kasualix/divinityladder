...
public enum ModArmorMaterials implements ArmorMaterial {
    OSIRIS_INGOT("osiris_ingot", 45, new int[]{9, 18, 24, 9}, 30, SoundEvents.ARMOR_EQUIP_DIAMOND,
            6.0F, 0.3F, () -> Ingredient.of(ModItems.OSIRIS_INGOT.get()));
   ...
   ModArmorMaterials(String p_40474_, int p_40475_, int[] p_40476_, int p_40477_, SoundEvent p_40478_, float p_40479_, float p_40480_, Supplier<Ingredient> p_40481_) {
    ...
    public String getName() {
        return DivinityLadder.MOD_ID + ":" +this.name;
    }
