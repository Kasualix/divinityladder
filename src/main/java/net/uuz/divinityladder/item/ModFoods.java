...
public class ModFoods {
    ...
    public static final FoodProperties LEMON = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.1F).effect(new MobEffectInstance(MobEffects.HUNGER, 100, 0), 0.2F).build();
    ...
    public static final FoodProperties SOYBEAN = (new FoodProperties.Builder()).fast().nutrition(1).saturationMod(0.1F).effect(new MobEffectInstance(MobEffects.CONFUSION, 120, 0), 0.2F).effect(new MobEffectInstance(MobEffects.POISON, 120, 0), 0.2F).build();
    ...
    public static final FoodProperties PICKLE = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).effect(new MobEffectInstance(MobEffects.HUNGER, 60, 0), 0.5F).build();
    public static final FoodProperties HAMBURGER = (new FoodProperties.Builder()).nutrition(16).saturationMod(1.5F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 0), 1.0F).effect(new MobEffectInstance(MobEffects.REGENERATION, 140, 0), 1.0F).effect(new MobEffectInstance(MobEffects.SATURATION, 400, 0), 1.0F).build();
}
